...
--
-- Host: localhost    Database: mw_118_wmf1
-- ------------------------------------------------------
...
--
-- Table structure for table `cl_house`
--

DROP TABLE IF EXISTS `cl_house`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cl_house` (
  `clh_id` int(10) unsigned NOT NULL,
...
-- Dump completed on 2012-01-18 11:33:38
